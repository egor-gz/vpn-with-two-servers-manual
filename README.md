# Подробная инструкция: как сделать двухсерверный VPN-сетап «Россия → Нидерланды»
...
- **Россия** — локация **Moscow**
- **Нидерланды** — локация **Amsterdam**

Практичный стартовый тариф для обоих серверов:

- **2 CPU / 4 GB RAM / 100 GB disk**

Если хочется сэкономить, базовый старт можно пробовать и со слабее конфигурацией, но для новичка 2/4 — спокойный и комфортный вариант.
...
4. Тариф: **2 CPU / 4 GB RAM / 100 GB disk**.
5. Завершите заказ.
